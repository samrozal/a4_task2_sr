...
# 1. Introduction
This report provides an exploratory overview into differences in weights of juvenile snowshoe hares observed at the Bonanza Creek Long Term Ecological Research site (a portion of the US Long Term Ecological Research Network) between the years of 1998 and 2012. Specifically, I analyze the differences in juvenile snowshoe hare weights between sexes (male and female) and experimental sites (Bonanza Riparian, Bonanza Mature, and Bonanza Black Spruce). We also frther explore the relationship between juvenile hare weight and juvenile hare hind foot length. 

# 2. Data and Methods
Measurements pertaining to snowshoe hare sizes were collected by Dr. Knut Kielland, Dr. Staurt Chapin, Dr. Roger Russ, and their team between the years of 1998 and 2012 in the Bonanza Creek Experimental Forest in Alaska, USA. The data covers 5 sites in which snowshoe hares were captured in traps, measured, and then released back into the the ecological reserve. Of these 5 sites, three of them are explored further in this report, as this report focuses on Juvenile snowshoe hares. Exploratory data visualization is first conducted in order to_____. Folowing this initial exploration, the difference between male and female weights is analysed using a Welch two-sample t-test, with a significance level of 0.05. The effect size is determined to further support ______. Furthermore, a simple linear regression model is built to explore the relationship between juvenile snowshoe hare weight and juvenile snowshoe hare hindfoot length. 
