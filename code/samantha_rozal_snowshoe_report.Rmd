...
Figure 1.*Count of Juvenile Hares Trapped by year.* Bar values represent the total number of juvenile hares that were trapped and subsequently observed each year. The number of observed hares greatly varied from year to year with a maximum number of hares trapped (126) occurring in 1999, and the minimum number of hares trapped (2) occurring in 2010. 

Throughout the entire study period, the number of observed trapped hares is overall trending downward, though there are spikes in number of hares trapped approximately every 3 years, There was a mean value of `r hares_summary_statistics$mean` hares observed and a median value of `r hares_summary_statistics$median` hares observed. These values, however, do not take into account effort as the number of traps set and number of days trapping was not standardized on a year to year basis. In order to more acuraely asses year to year trends, it would be beneficial to divide by some value represnting size, such as area of land studied or number of traps set.  
...
Future analysis surrounding this topic should include:
 ...
 - Test if the relationship between weight and hind leg size follows non-linear models such as exponential or logistic models.
