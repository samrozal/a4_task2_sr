...
juvenile_hare_cor <- cor.test(juvenile_hares_date$weight, juvenile_hares_date$hindft)
...
r squared value is`r round(juvenile_hares_lm_glance$r.squared[1], 3)`
pearson's r is `r round(juvenile_hares_cor_tidy$estimate,2)`

We analyzed the relationship between juvenile hare weight (mass) and hind foot length across all juvenile hares observed during the study period. Although the relationship provides valuable insight to the ___, there is a necessity for further naysis that also includes sex of the juvenile hare and the site at which the hares were observed/trapped as variables, as these are likly to also have an impact on rabbit weight.

There is a somewhat linear relationship that exists between 
